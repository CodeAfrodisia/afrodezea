// scripts/seed_self_love_style.mjs
...
// Helpful guard + visibility
console.log("🔧 Seeding: self-love-style");
...
async function main() {
      ...
      results: [
        {
          ...
          product_suggestions: [
            { kind: "candle", sku: "iam-intentional", reason: "Set a consistent ritual tone." },
            { kind: "journal", sku: "ritual-journal", reason: "Track your daily practices with grace." }
          ]
        },
        {
          key: "indulger",
          ...
          product_suggestions: [
            { kind: "candle", sku: "iam-soft", reason: "Invite warmth and calm into your space." },
            { kind: "bundle", sku: "spa-ritual", reason: "Turn pampering into a nourishing ritual." }
          ]
        },
        {
          key: "creator",
          ...
          product_suggestions: [
            { kind: "journal", sku: "ideas-notebook", reason: "Catch sparks and sketches." },
            { kind: "candle", sku: "iam-inspired", reason: "Pair making with a signature vibe." }
          ]
        },
        {
          key: "reflector",
          ...
          product_suggestions: [
            { kind: "journal", sku: "reflection-journal", reason: "Hold space for inner voice." },
            { kind: "candle", sku: "iam-grounded", reason: "Anchor calm & clarity." }
          ]
        },
        {
          key: "connector",
          ...
          product_suggestions: [
            { kind: "ritual", sku: "gratitude-circle", reason: "Invite shared reflection rituals." },
            { kind: "candle", sku: "i-am-love", reason: "Set the table for warmth and belonging." }
          ]
        },
        {
          key: "achiever",
          ...
          product_suggestions: [
            { kind: "tracker", sku: "habit-tracker", reason: "See your consistency build momentum." },
            { kind: "candle", sku: "iam-confident", reason: "Mark accomplishments with ceremony." }
          ]
        }
      ],
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { key: "s4_a", label: "Guided meditation, prayer, or therapy homework.",
              weights: { reflector: 2 }, tags: ["inner-work"] },
            { key: "s4_b", label: "Make something beautiful: playlist, mood board, recipe.",
              weights: { creator: 2 }, tags: ["creative-care"] },
        ...
        // scale keys: sd = strongly disagree, d = disagree, n = neutral, a = agree, sa = strongly agree
        {
          ...
          options: [
            ...
            { key: "l1_n",  label: "Neutral",           weights: { achiever: 1 } },
            { key: "l1_a",  label: "Agree",             weights: { achiever: 2, ritualist: 1 } },
            { key: "l1_sa", label: "Strongly agree",    weights: { achiever: 2, ritualist: 2 } }
          ]
        },
        {
          id: "l2",
          ...
          options: [
            ...
            { key: "l2_n",  label: "Neutral",           weights: { creator: 1 } },
            { key: "l2_a",  label: "Agree",             weights: { indulger: 2, creator: 1 } },
            { key: "l2_sa", label: "Strongly agree",    weights: { indulger: 2, creator: 2 } }
          ]
        },
        {
          id: "l3",
          ...
          options: [
            ...
            { key: "l3_n",  label: "Neutral",           weights: { reflector: 1 } },
            { key: "l3_a",  label: "Agree",             weights: { reflector: 2, ritualist: 1 } },
            { key: "l3_sa", label: "Strongly agree",    weights: { reflector: 2, ritualist: 2 } }
          ]
        },
  ...
  if (error) {
    console.error("❌ Error seeding Self-Love Style:", error);
    process.exit(1);
  }
  console.log("✅ Seeded:", data?.map(r => `${r.slug} (v${r.questions?.version ?? "?"})`).join(", "));

  // Optional: show current questions count
  const count = quiz.questions.questions.length;
  console.log(`ℹ️  Inserted/updated with ${count} questions and ${quiz.questions.results.length} result buckets.`);
}
