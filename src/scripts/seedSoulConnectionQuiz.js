    ...
    results: [
      {
        ...
        summary:
          "Peaceful, supportive, enduring. The connection feels like home—grounding, gentle growth, low drama.",
        guidance: [
      ...
      },
      {
        ...
        summary:
          "Magnetic, transformative, sometimes volatile. Passion intertwines with shadow work and rapid growth.",
        guidance: [
      ...
      },
      {
        ...
        summary:
          "Deep recognition and quiet resonance—same essence, shared direction, minimal chaos with profound depth.",
        guidance: [
      ...
      },
      {
        ...
        summary:
          "Growth through friction, repeating loops until a lesson lands. Valuable, sometimes temporary.",
        guidance: [
      ...
      },
      {
        ...
        summary:
          "Aligned, light, often seasonal. Easy presence, meaningful moments, minimal heavy lessons.",
        guidance: [
